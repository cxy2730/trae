...
// Size:     395 bytes
// Conv:     unknown
// Signature: undefined FUN_0048d0a0(void)
// Decompiled by Ghidra 12.1.2


int FUN_0048d0a0(DWORD param_1,char *param_2,uint param_3)
...
LAB_0048d188:
      ...
      if (param_1 == 0) goto LAB_0048d1fa;
      if (param_1 == 5) {
      ...
      if (param_3 != 0) {
        do {
          ...
          if (((int)local_10 < (int)pcVar5 - (int)local_418) ||
             (param_3 <= (uint)((int)local_8 - (int)param_2))) goto LAB_0048d188;
        } while( true );
      }
LAB_0048d1fa:
      if (((*(byte *)(*piVar1 + 4 + iVar4) & 0x40) != 0) && (*param_2 == '\x1a')) goto LAB_0048d0b9;
      puVar7 = (undefined4 *)FUN_004843ad();
      *puVar7 = 0x1c;
      puVar7 = (undefined4 *)FUN_004843b6();
      *puVar7 = 0;

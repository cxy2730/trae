...
// Size:     518 bytes
// Conv:     unknown
// Signature: undefined FUN_004894a6(void)
// Decompiled by Ghidra 12.1.2


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 FUN_004894a6(undefined4 param_1,uint param_2,ushort param_3)

{
  ...
  if ((((((CONCAT22(param_3,param_2._2_2_) ^ 0x700) & 0x700) == 0) &&
       ((&DAT_02fd969c)[(param_2._2_2_ & 0x7800) >> 0xb] != '\0')) && ((param_3 & 0x7fff) != 0x7fff)
    ...
    if ((ushort)((param_3 & 0x7fff) + 0x3f) < (in_stack_00000024 & 0x7fff)) {
      ...
      do {
        ...
        fVar3 = fVar3 * (float10)_DAT_02fd96cc;
        iVar1 = iVar1 + -1;
      } while (iVar1 != 0);
    }
    else {

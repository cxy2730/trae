...
// Size:     140 bytes
// Conv:     unknown
// Signature: undefined __trandisp2(void)
...

{
  ...
  *(ushort *)(unaff_EBP + -0xa0) =
  ...
  cVar2 = (char)(*(char *)(unaff_EBP + -0x9f) << 1) >> 1;
                    /* WARNING: Could not recover jumptable at 0x00487d21. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(param_2 + (char)((&DAT_02fd954c)[(byte)(cVar2 << 1 | cVar2 < '\0') & 0xf] |
                               (&DAT_02fd954c)[(byte)((bVar3 & 7) << 1 | (char)bVar3 < '\0')] << 2)
              + 0x10))();
  return;
}

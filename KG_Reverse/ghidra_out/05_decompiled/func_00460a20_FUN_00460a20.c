...
// Size:     911 bytes
// Conv:     unknown
// Signature: undefined FUN_00460a20(void)
// Decompiled by Ghidra 12.1.2


undefined4 FUN_00460a20(uint param_1,int param_2,int param_3,int param_4,int param_5,int *param_6)

{
  ...
  uVar6 = *(uint *)(&DAT_02fb4530 + param_1 * 4);
  uVar5 = *(uint *)(&DAT_02fb4530 + param_2 * 4);
  do {
      ...
      *local_10 = *(undefined1 *)(iVar13 + 4);
      ...
      while ((bVar2 & 0x10) == 0) {
        if ((uVar9 & 0x40) != 0) {
          ...
          param_6[6] = (int)s_invalid_literal_length_code_02fb45bc;
          uVar6 = uVar3 >> 3;
          if (uVar3 >> 3 < uVar5) goto LAB_00460d6f;
          goto LAB_00460d71;
        }
        iVar4 = (*(uint *)(&DAT_02fb4530 + uVar9 * 4) & uVar7) + *(int *)(iVar13 + 4);
        bVar2 = *(byte *)(iVar13 + iVar4 * 8);
        uVar9 = (uint)bVar2;
        iVar13 = iVar13 + iVar4 * 8;
        if (uVar9 == 0) goto LAB_00460c58;
        uVar7 = uVar7 >> (*(byte *)(iVar13 + 1) & 0x1f);
        uVar3 = uVar3 - *(byte *)(iVar13 + 1);
      }
      uVar9 = uVar9 & 0xf;
      param_1 = (*(uint *)(&DAT_02fb4530 + uVar9 * 4) & uVar7) + *(int *)(iVar13 + 4);
      ...
      while ((bVar2 & 0x10) == 0) {
        if ((bVar2 & 0x40) != 0) {
          uVar5 = param_6[1] - local_14;
          param_6[6] = (int)s_invalid_distance_code_02fb45d8;
          uVar6 = uVar3 >> 3;
          if (uVar3 >> 3 < uVar5) {
LAB_00460d6f:
            uVar5 = uVar6;
...
LAB_00460d71:
        ...
        iVar4 = (*(uint *)(&DAT_02fb4530 + (uint)bVar2 * 4) & uVar7) + *(int *)(iVar13 + 4);
      ...
      uVar8 = (*(uint *)(&DAT_02fb4530 + uVar9 * 4) & uVar7) + *(int *)(iVar13 + 4);

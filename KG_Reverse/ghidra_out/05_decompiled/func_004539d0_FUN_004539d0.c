...
// Size:     385 bytes
// Conv:     unknown
// Signature: undefined FUN_004539d0(void)
// Decompiled by Ghidra 12.1.2


void FUN_004539d0(int param_1)

{
  ...
  if (0 < iVar4) {
    iVar3 = FUN_00456450(param_1,iVar4,iVar5,*(undefined4 *)(iVar1 + 0x48));
    if (iVar3 < iVar5) {
      iVar3 = iVar3 / iVar4;
      if (iVar3 < 1) {
        iVar3 = 1;
    ...
    for (piVar2 = *(int **)(iVar1 + 0x40); piVar2 != (int *)0x0; piVar2 = (int *)piVar2[0xb]) {
      if (*piVar2 == 0) {
        if (iVar3 < (int)((piVar2[1] - 1U) / (uint)piVar2[3] + 1)) {
          ...
          FUN_00456460(param_1,piVar2 + 0xc,piVar2[2] * piVar2[1]);
          piVar2[10] = 1;
        }
        else {
          piVar2[4] = piVar2[1];
        }
        iVar4 = FUN_004537c0(param_1,1,piVar2[2],piVar2[4]);
        *piVar2 = iVar4;
    ...
    for (piVar2 = *(int **)(iVar1 + 0x44); piVar2 != (int *)0x0; piVar2 = (int *)piVar2[0xb]) {
      if (*piVar2 == 0) {
        if (iVar3 < (int)((piVar2[1] - 1U) / (uint)piVar2[3] + 1)) {
          piVar2[4] = piVar2[3] * iVar3;
          FUN_00456460(param_1,piVar2 + 0xc,piVar2[2] * piVar2[1] * 0x80);
          piVar2[10] = 1;
        }
        else {
          piVar2[4] = piVar2[1];
        }
        iVar4 = FUN_00453860(param_1,1,piVar2[2],piVar2[4]);
        *piVar2 = iVar4;
        piVar2[5] = *(int *)(iVar1 + 0x4c);
        piVar2[6] = 0;
        piVar2[7] = 0;

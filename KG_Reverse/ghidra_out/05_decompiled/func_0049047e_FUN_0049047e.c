...
// Size:     659 bytes
// Conv:     unknown
// Signature: undefined FUN_0049047e(void)
// Decompiled by Ghidra 12.1.2


undefined4
FUN_0049047e(int param_1,uint param_2,uint param_3,int param_4,byte param_5,short *param_6)
      ...
      *param_6 = 1;
      if (((param_2 == 0x80000000) && (param_1 == 0)) || ((param_2 & 0x40000000) != 0)) {
        if (((param_3 & 0x8000) == 0) || (param_2 != 0xc0000000)) {
          if ((param_2 != 0x80000000) || (param_1 != 0)) goto LAB_00490573;
          pcVar10 = "1#INF";
        }
        else {
          if (param_1 != 0) {
LAB_00490573:
        ...
        FUN_00489dc0(param_6 + 2,pcVar10);
...
LAB_00490578:
    ...
    sVar7 = (short)(((uVar4 >> 8) + (param_2 >> 0x18) * 2) * 0x4d + -0x134312f4 + uVar4 * 0x4d10 >>
                   0x10);
    FUN_00490931(&local_14,-(int)sVar7,1);
    if (0x3ffe < CONCAT11(cStack_9,local_a)) {
      sVar7 = sVar7 + 1;
      FUN_00490711(&local_14,&local_20);
    }
    *psVar2 = sVar7;
    iVar9 = param_4;
    if (((param_5 & 1) == 0) || (iVar9 = param_4 + sVar7, 0 < param_4 + sVar7)) {
      ...
      if ('4' < *(char *)((int)psVar5 + -1)) {
        for (; psVar1 <= psVar6; psVar6 = (short *)((int)psVar6 + -1)) {
          if ((char)*psVar6 != '9') {
            if (psVar1 <= psVar6) goto LAB_004906d0;
            break;
          }
          *(char *)psVar6 = '0';
        }
...
LAB_004906d2:
      ...
      for (; psVar1 <= psVar6; psVar6 = (short *)((int)psVar6 + -1)) {
        if ((char)*psVar6 != '0') {
          if (psVar1 <= psVar6) goto LAB_004906d2;
          break;
        }
      }
      *psVar2 = 0;

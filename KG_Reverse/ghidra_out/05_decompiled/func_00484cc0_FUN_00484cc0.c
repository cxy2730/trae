...
// Size:     353 bytes
// Conv:     unknown
// Signature: undefined FUN_00484cc0(void)
// Decompiled by Ghidra 12.1.2


int FUN_00484cc0(char *param_1)

{
  ...
  local_8 = FUN_0048e032(uVar1,0,1);
  if (local_8 < 0) {
LAB_00484d4e:
    local_c = -1;
  }
    ...
    if ((uVar2 & 3) == 0) {
      ...
      pcVar8 = pcVar7;
      if ((*(byte *)((&DAT_03014ec0)[(int)uVar1 >> 5] + 4 + (uVar1 & 0x1f) * 0x24) & 0x80) != 0) {
    ...
    if (local_8 != 0) {
      if ((*(byte *)((int)param_1 + 0xc) & 1) != 0) {
        if (*(int *)((int)param_1 + 4) == 0) {
          ...
          if ((*(byte *)(iVar9 + 4 + (&DAT_03014ec0)[(int)uVar1 >> 5]) & 0x80) != 0) {
            iVar6 = FUN_0048e032(uVar1,0,2);
            if (iVar6 == local_8) {
              pcVar7 = *(char **)((int)param_1 + 8);

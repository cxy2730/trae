...
// Size:     544 bytes
// Conv:     unknown
// Signature: undefined FUN_00490711(void)
// Decompiled by Ghidra 12.1.2


void FUN_00490711(int *param_1,int *param_2)
...
LAB_004907b4:
    ...
    if (((uVar6 != 0) || (uVar3 = uVar3 + 1, (param_1[2] & 0x7fffffffU) != 0)) ||
      ...
      if (((uVar8 == 0) && (uVar3 = uVar3 + 1, (param_2[2] & 0x7fffffffU) == 0)) &&
         ((param_2[1] == 0 && (*param_2 == 0)))) goto LAB_004907b4;
      local_14 = 0;
      local_8 = &local_24;
      param_2 = (int *)0x5;
      do {
        if (0 < (int)param_2) {
          ...
          do {
            iVar7 = FUN_004902dd(*(undefined4 *)(local_8 + -2),(uint)*local_c * (uint)*local_10,
                                 local_8 + -2);
            if (iVar7 != 0) {
              *local_8 = *local_8 + 1;
            }
...
LAB_00490868:
        ...
        do {
          ...
          FUN_0049035c(&local_28);
          param_1._0_2_ = (ushort)param_1 - 1;
        } while (0 < (short)(ushort)param_1);
        if ((short)(ushort)param_1 < 1) goto LAB_00490868;
      }
      ...
      if (0x7ffe < (ushort)param_1) goto LAB_00490911;

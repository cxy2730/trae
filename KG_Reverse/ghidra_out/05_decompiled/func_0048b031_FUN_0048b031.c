...
// Size:     777 bytes
// Conv:     unknown
// Signature: undefined FUN_0048b031(void)
// Decompiled by Ghidra 12.1.2


int * FUN_0048b031(uint *param_1)

{
  ...
  puVar12 = DAT_03014e9c;
  if (param_1 == puVar9) {
    for (; (puVar12 < DAT_03014e90 && ((puVar12[1] & local_c) == 0 && (*puVar12 & local_10) == 0));
        puVar12 = puVar12 + 5) {
    }
    param_1 = puVar12;
    if (puVar12 == DAT_03014e90) {
      for (; (puVar12 < puVar9 && (puVar12[2] == 0)); puVar12 = puVar12 + 5) {
      }
      puVar13 = DAT_03014e9c;
      param_1 = puVar12;
      if (puVar12 == puVar9) {
        for (; (puVar13 < DAT_03014e90 && (puVar13[2] == 0)); puVar13 = puVar13 + 5) {
        }
        param_1 = puVar13;
        if ((puVar13 == DAT_03014e90) && (param_1 = (uint *)FUN_0048b33a(), param_1 == (uint *)0x0))
        {
          return (int *)0x0;
        }
      }
      uVar5 = FUN_0048b3eb(param_1);
...
LAB_0048b2f7:
  ...
  *(uint *)((int)piVar11 + (uVar7 - 4)) = uVar7 + 1;
  iVar8 = *piVar2;
  *piVar2 = iVar8 + 1;
  if (((iVar8 == 0) && (param_1 == DAT_03014e94)) && (local_8 == DAT_03014e8c)) {
    DAT_03014e94 = (uint *)0x0;
  }
  *piVar4 = local_8;
  return piVar11 + 1;
}

...
void* sub_4210b0(void) {
  ...
  // push 0
  // push eax
  // call dword ptr [0x4a24c0]
  call(dword ptr [0x4a24c0]);
  /* Block 29 @ 0x004211E3 */
  // push edi
  // push eax
  // call dword ptr [0x4a2438]
  call(dword ptr [0x4a2438]);
  /* Block 30 @ 0x00421200 */
  // mov eax, dword ptr [esi + 0x68]
  // TEST eax, eax (set flags)
  // if (not equal) goto 0x421211
  /* Block 31 @ 0x004211EB */
  goto 0x421200;
  /* Block 32 @ 0x00421207 */
